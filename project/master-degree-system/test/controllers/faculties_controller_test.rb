...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { creator_id: @faculty.creator_id, modifier_id: @faculty.modifier_id, name: @faculty.name }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { creator_id: @faculty.creator_id, modifier_id: @faculty.modifier_id, name: @faculty.name }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
