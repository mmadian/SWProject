...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { creator_id: @semester.creator_id, modifier_id: @semester.modifier_id, semesterName: @semester.semesterName }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { creator_id: @semester.creator_id, modifier_id: @semester.modifier_id, semesterName: @semester.semesterName }
    assert_redirected_to semester_path(assigns(:semester))
  end
