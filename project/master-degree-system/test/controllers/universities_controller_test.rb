...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { creator_id: @university.creator_id, modifier_id: @university.modifier_id, name: @university.name }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { creator_id: @university.creator_id, modifier_id: @university.modifier_id, name: @university.name }
    assert_redirected_to university_path(assigns(:university))
  end
